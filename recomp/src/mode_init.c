...
void mode0_level_init(SnesState* ss) {
  ...
  SIMM16(0x8295); a = 0x0001; ss_set_nz16(ss, a);   /* C08295 lda #$0001 */
  S(0x8298, 3); t_write16(ss, ss_abs(ss, BGMODE), a);   /* C08298 sta BGMODE */
  SIMM16(0x829B); a = 0x1417; ss_set_nz16(ss, a);   /* C0829B lda #$1417 */
  S(0x829E, 3); t_write16(ss, ss_abs(ss, TM), a);       /* C0829E sta TM */
  SIMM16(0x82A1); a = 0x8202; ss_set_nz16(ss, a);   /* C082A1 lda #$8202 */
  S(0x82A4, 3); t_write16(ss, ss_abs(ss, CGWSEL), a);   /* C082A4 sta CGWSEL */
  SIMM16(0x82A7); a = 0x0525; ss_set_nz16(ss, a);   /* C082A7 lda #$0525 */
  S(0x82AA, 3); t_write16(ss, ss_abs(ss, BG12NBA), a);  /* C082AA sta BG12NBA */
  SIMM16(0x82AD); a = 0x7969; ss_set_nz16(ss, a);   /* C082AD lda #$7969 */
  S(0x82B0, 3); t_write16(ss, ss_abs(ss, BG1SC), a);    /* C082B0 sta BG1SC */
  SIMM16(0x82B3); a = 0x001C; ss_set_nz16(ss, a);   /* C082B3 lda #$001C */
  ...
  SIMM16(0x82BC); a = 0x0DFF; ss_set_nz16(ss, a);   /* C082BC lda #$0DFF */
  S(0x82BF, 2);                             /* C082BF sta level_width_mask */
  t_write16_dp(ss, dp, level_width_mask, a);
  SIMM16(0x82C1); a = 0x011F; ss_set_nz16(ss, a);   /* C082C1 lda #$011F */
  S(0x82C4, 2);                             /* C082C4 sta level_height_mask */
  t_write16_dp(ss, dp, level_height_mask, a);
  S(0x82C6, 2);                             /* C082C6 stz $82 */
  t_write16_dp(ss, dp, layer2_parallax_shift, 0);
  SIMM16(0x82C8); a = 0x0020; ss_set_nz16(ss, a);   /* C082C8 lda #$0020 */
  S(0x82CB, 2);                             /* C082CB sta $84 */
  t_write16_dp(ss, dp, layer2_row_height, a);
  SIMM16(0x82CD); a = 0x4860; ss_set_nz16(ss, a);   /* C082CD lda #$4860 */
  S(0x82D0, 2);                             /* C082D0 sta tilemap_a_addr */
  t_write16_dp(ss, dp, tilemap_a_addr, a);
  SIMM16(0x82D2); a = 0xCACA; ss_set_nz16(ss, a);   /* C082D2 lda #$CACA */
  S(0x82D5, 2);                             /* C082D5 sta tilemap_a_bank */
  t_write16_dp(ss, dp, tilemap_a_bank, a);
  SIMM16(0x82D7); a = 0xDCE0; ss_set_nz16(ss, a);   /* C082D7 lda #$DCE0 */
  S(0x82DA, 2);                             /* C082DA sta tilemap_b_addr */
  t_write16_dp(ss, dp, tilemap_b_addr, a);
  SIMM16(0x82DC); a = 0xC9C9; ss_set_nz16(ss, a);   /* C082DC lda #$C9C9 */
  S(0x82DF, 2);                             /* C082DF sta metatile_data_bank */
  t_write16_dp(ss, dp, metatile_data_bank, a);
  SIMM16(0x82E1); a = 0xFFFF; ss_set_nz16(ss, a);   /* C082E1 lda #$FFFF */
  S(0x82E4, 2);                             /* C082E4 sta layer_parallax_mode */
  t_write16_dp(ss, dp, layer_parallax_mode, a);
  S(0x82E6, 2);                             /* C082E6 stz $60 */
  t_write16_dp(ss, dp, scroll_scratch_60, 0);
  SIMM16(0x82E8); a = 0x0048; ss_set_nz16(ss, a);   /* C082E8 lda #$0048 */
  S(0x82EB, 2);                             /* C082EB sta camera_y */
  t_write16_dp(ss, dp, camera_y, a);
  SIMM16(0x82ED); a = 0x0000; ss_set_nz16(ss, a);   /* C082ED lda #$0000 */

  for(;;) {                                 /* loc_C082F0 */
    S(0x82F0, 2);                           /* C082F0 sta camera_x */
    t_write16_dp(ss, dp, camera_x, a);
    ...
    a = t_read16_dp(ss, dp, camera_x);
    ss_set_nz16(ss, a);
    SI(0x82FA); ss_set_c(ss, false);        /* C082FA clc */
    SIMM16(0x82FB); a = alu_adc16(ss, a, 0x0008);   /* C082FB adc #$0008 */
    SIMM16(0x82FE); alu_cmp16(ss, a, 0x0100); /* C082FE cmp #$0100 */
  ...
  SIMM16(0x8305); a = 0x1600; ss_set_nz16(ss, a);   /* C08305 lda #$1600 */
  S(0x8308, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08308 sta VMADDL */
  SIMM16(0x830B); x = 0x00C5; ss_set_nz16(ss, x);   /* C0830B ldx #$00C5 */
  SIMM16(0x830E); a = 0x02C0; ss_set_nz16(ss, a);   /* C0830E lda #$02C0 */
  SIMM16(0x8311); y = 0x0C00; ss_set_nz16(ss, y);   /* C08311 ldy #$0C00 */
  JSR(0x8314, dma_upload_to_vram_addr);     /* C08314 jsr dma_upload_to_vram */

  SIMM16(0x8317); a = 0x1C00; ss_set_nz16(ss, a);   /* C08317 lda #$1C00 */
  S(0x831A, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C0831A sta VMADDL */
  SIMM16(0x831D); x = 0x00CA; ss_set_nz16(ss, x);   /* C0831D ldx #$00CA */
  SIMM16(0x8320); a = 0xE38E; ss_set_nz16(ss, a);   /* C08320 lda #$E38E */
  SIMM16(0x8323); y = 0x0800; ss_set_nz16(ss, y);   /* C08323 ldy #$0800 */
  JSR(0x8326, dma_upload_to_vram_addr);     /* C08326 jsr dma_upload_to_vram */

  SIMM16(0x8329); a = 0x2000; ss_set_nz16(ss, a);   /* C08329 lda #$2000 */
  S(0x832C, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C0832C sta VMADDL */
  SIMM16(0x832F); x = 0x00C9; ss_set_nz16(ss, x);   /* C0832F ldx #$00C9 */
  SIMM16(0x8332); a = 0x0000; ss_set_nz16(ss, a);   /* C08332 lda #$0000 */
  SIMM16(0x8335); y = 0x5AC0; ss_set_nz16(ss, y);   /* C08335 ldy #$5AC0 */
  JSR(0x8338, dma_upload_to_vram_addr);     /* C08338 jsr dma_upload_to_vram */

  SIMM16(0x833B); a = 0x5000; ss_set_nz16(ss, a);   /* C0833B lda #$5000 */
  S(0x833E, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C0833E sta VMADDL */
  SIMM16(0x8341); x = 0x00C9; ss_set_nz16(ss, x);   /* C08341 ldx #$00C9 */
  SIMM16(0x8344); a = 0x8AC0; ss_set_nz16(ss, a);   /* C08344 lda #$8AC0 */
  SIMM16(0x8347); y = 0x2AA0; ss_set_nz16(ss, y);   /* C08347 ldy #$2AA0 */
  JSR(0x834A, dma_upload_to_vram_addr);     /* C0834A jsr dma_upload_to_vram */

  SIMM16(0x834D); a = 0x6800; ss_set_nz16(ss, a);   /* C0834D lda #$6800 */
  S(0x8350, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08350 sta VMADDL */
  SIMM16(0x8353); x = 0x00CA; ss_set_nz16(ss, x);   /* C08353 ldx #$00CA */
  SIMM16(0x8356); a = 0xF38E; ss_set_nz16(ss, a);   /* C08356 lda #$F38E */
  SIMM16(0x8359); y = 0x0800; ss_set_nz16(ss, y);   /* C08359 ldy #$0800 */
  JSR(0x835C, dma_upload_to_vram_addr);     /* C0835C jsr dma_upload_to_vram */

  SIMM16(0x835F); a = 0x6C00; ss_set_nz16(ss, a);   /* C0835F lda #$6C00 */
  JSR(0x8362, dma_fill_vram_zero_addr);     /* C08362 jsr dma_fill_vram_zero */

  SIMM16(0x8365); a = 0x7000; ss_set_nz16(ss, a);   /* C08365 lda #$7000 */
  S(0x8368, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08368 sta VMADDL */
  SIMM16(0x836B); x = 0x00CA; ss_set_nz16(ss, x);   /* C0836B ldx #$00CA */
  SIMM16(0x836E); a = 0xEB8E; ss_set_nz16(ss, a);   /* C0836E lda #$EB8E */
  SIMM16(0x8371); y = 0x0800; ss_set_nz16(ss, y);   /* C08371 ldy #$0800 */
  JSR(0x8374, dma_upload_to_vram_addr);     /* C08374 jsr dma_upload_to_vram */

  SIMM16(0x8377); a = 0x7400; ss_set_nz16(ss, a);   /* C08377 lda #$7400 */
  JSR(0x837A, dma_fill_vram_zero_addr);     /* C0837A jsr dma_fill_vram_zero */

  SIMM16(0x837D); y = 0x0000; ss_set_nz16(ss, y);   /* C0837D ldy #$0000 */
  SIMM16(0x8380); x = 0x0020; ss_set_nz16(ss, x);   /* C08380 ldx #$0020 */
  SIMM16(0x8383); a = 0x6DA8; ss_set_nz16(ss, a);   /* C08383 lda #$6DA8 */
  JSR(0x8386, dma_upload_to_cgram_addr);    /* C08386 jsr dma_upload_to_cgram */

  SIMM16(0x8389); y = 0x0080; ss_set_nz16(ss, y);   /* C08389 ldy #$0080 */
  SIMM16(0x838C); x = 0x0020; ss_set_nz16(ss, x);   /* C0838C ldx #$0020 */
  SIMM16(0x838F); a = 0x6C48; ss_set_nz16(ss, a);   /* C0838F lda #$6C48 */
  JSR(0x8392, dma_upload_to_cgram_addr);    /* C08392 jsr dma_upload_to_cgram */

  SIMM16(0x8395); y = 0x00E0; ss_set_nz16(ss, y);   /* C08395 ldy #$00E0 */
  SIMM16(0x8398); x = 0x0004; ss_set_nz16(ss, x);   /* C08398 ldx #$0004 */
  SIMM16(0x839B); a = 0x6D68; ss_set_nz16(ss, a);   /* C0839B lda #$6D68 */
  JSR(0x839E, dma_upload_to_cgram_addr);    /* C0839E jsr dma_upload_to_cgram */

  SIMM16(0x83A1); y = 0x00F0; ss_set_nz16(ss, y);   /* C083A1 ldy #$00F0 */
  SIMM16(0x83A4); x = 0x0004; ss_set_nz16(ss, x);   /* C083A4 ldx #$0004 */
  SIMM16(0x83A7); a = 0x6D48; ss_set_nz16(ss, a);   /* C083A7 lda #$6D48 */
  ...
  SIMM16(0x83B0); a = 0x1016; ss_set_nz16(ss, a);   /* C083B0 lda #$1016 */
  ...
  SIMM16(0x83BD); a = 0x0080; ss_set_nz16(ss, a);   /* C083BD lda #$0080 */
  S(0x83C0, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C083C0 sta ptr_04 */
  SIMM16(0x83C2); a = 0x84A2; ss_set_nz16(ss, a);   /* C083C2 lda #$84A2 */
  SIMM16(0x83C5); y = 0x2C41; ss_set_nz16(ss, y);   /* C083C5 ldy #$2C41 */
  SIMM16(0x83C8); x = 0x0010; ss_set_nz16(ss, x);   /* C083C8 ldx #$0010 */
  JSR(0x83CB, dma_setup_channel_step_addr); /* C083CB jsr dma_setup_channel_step */

  SIMM16(0x83CE); a = 0x0080; ss_set_nz16(ss, a);   /* C083CE lda #$0080 */
  S(0x83D1, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C083D1 sta ptr_04 */
  SIMM16(0x83D3); a = 0x84A9; ss_set_nz16(ss, a);   /* C083D3 lda #$84A9 */
  SIMM16(0x83D6); y = 0x1143; ss_set_nz16(ss, y);   /* C083D6 ldy #$1143 */
  SIMM16(0x83D9); x = 0x0020; ss_set_nz16(ss, x);   /* C083D9 ldx #$0020 */
  JSR(0x83DC, dma_setup_channel_step_addr); /* C083DC jsr dma_setup_channel_step */

  SIMM16(0x83DF); a = 0x0080; ss_set_nz16(ss, a);   /* C083DF lda #$0080 */
  S(0x83E2, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C083E2 sta ptr_04 */
  SIMM16(0x83E4); a = 0x84B0; ss_set_nz16(ss, a);   /* C083E4 lda #$84B0 */
  SIMM16(0x83E7); y = 0x0900; ss_set_nz16(ss, y);   /* C083E7 ldy #$0900 */
  SIMM16(0x83EA); x = 0x0030; ss_set_nz16(ss, x);   /* C083EA ldx #$0030 */
  JSR(0x83ED, dma_setup_channel_step_addr); /* C083ED jsr dma_setup_channel_step */

  SIMM16(0x83F0); a = 0x7F00; ss_set_nz16(ss, a);   /* C083F0 lda #$7F00 */
  S(0x83F3, 3); t_write16(ss, ss_abs(ss, 0x0C00), a); /* C083F3 sta $0C00 */
  SIMM16(0x83F6); a = 0x007F; ss_set_nz16(ss, a);   /* C083F6 lda #$007F */
  S(0x83F9, 4); t_write16(ss, 0x7F00D0, a); /* C083F9 sta $7F00D0 */
  SIMM16(0x83FD); a = 0x003D; ss_set_nz16(ss, a);   /* C083FD lda #$003D */
  S(0x8400, 4); t_write16(ss, 0x7F00D3, a); /* C08400 sta $7F00D3 */
  SIMM16(0x8404); a = 0x0001; ss_set_nz16(ss, a);   /* C08404 lda #$0001 */
  S(0x8407, 4); t_write16(ss, 0x7F00D6, a); /* C08407 sta $7F00D6 */
  SIMM16(0x840B); a = 0x0BF8; ss_set_nz16(ss, a);   /* C0840B lda #$0BF8 */
  ...
  SIMM16(0x8427); a = 0x6969; ss_set_nz16(ss, a);   /* C08427 lda #$6969 */
  S(0x842A, 3); t_write16(ss, ss_abs(ss, 0x0BF8), a); /* C0842A sta $0BF8 */

  SIMM16(0x842D); a = 0x007F; ss_set_nz16(ss, a);   /* C0842D lda #$007F */
  S(0x8430, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C08430 sta ptr_04 */
  SIMM16(0x8432); a = 0x00D0; ss_set_nz16(ss, a);   /* C08432 lda #$00D0 */
  SIMM16(0x8435); y = 0x0740; ss_set_nz16(ss, y);   /* C08435 ldy #$0740 */
  SIMM16(0x8438); x = 0x0040; ss_set_nz16(ss, x);   /* C08438 ldx #$0040 */
  JSR(0x843B, dma_setup_channel_step_addr); /* C0843B jsr dma_setup_channel_step */

  SIMM16(0x843E); a = 0xFF00; ss_set_nz16(ss, a);   /* C0843E lda #$FF00 */
  S(0x8441, 3); t_write16(ss, ss_abs(ss, 0x0C04), a); /* C08441 sta $0C04 */
  SIMM16(0x8444); a = 0x00FF; ss_set_nz16(ss, a);   /* C08444 lda #$00FF */
  S(0x8447, 4); t_write16(ss, 0x7F0540, a); /* C08447 sta $7F0540 */
  SIMM16(0x844B); a = 0x003D; ss_set_nz16(ss, a);   /* C0844B lda #$003D */
  S(0x844E, 4); t_write16(ss, 0x7F0543, a); /* C0844E sta $7F0543 */
  SIMM16(0x8452); a = 0x0001; ss_set_nz16(ss, a);   /* C08452 lda #$0001 */
  S(0x8455, 4); t_write16(ss, 0x7F0546, a); /* C08455 sta $7F0546 */
  SIMM16(0x8459); a = 0x0C31; ss_set_nz16(ss, a);   /* C08459 lda #$0C31 */
  S(0x845C, 4); t_write16(ss, 0x7F0541, a); /* C0845C sta $7F0541 */
  SIMM16(0x8460); a = 0x0D2F; ss_set_nz16(ss, a);   /* C08460 lda #$0D2F */
  S(0x8463, 4); t_write16(ss, 0x7F0544, a); /* C08463 sta $7F0544 */
  SIMM16(0x8467); a = 0x0DB5; ss_set_nz16(ss, a);   /* C08467 lda #$0DB5 */
  ...
  SIMM16(0x8473); x = 0x0186; ss_set_nz16(ss, x);   /* C08473 ldx #$0186 */
  SI(0x8476); a = ss_dp(ss); ss_set_nz16(ss, a);  /* C08476 tdc */
  for(;;) {                                 /* loc_C08477 */
    S(0x8477, 3); t_index(ss);              /* C08477 sta $0C31,X */
    t_write16(ss, ss_abs(ss, (0x0C31 + x)), a);
  ...
  SIMM16(0x847E); a = 0x007F; ss_set_nz16(ss, a);   /* C0847E lda #$007F */
  S(0x8481, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C08481 sta ptr_04 */
  SIMM16(0x8483); a = 0x0540; ss_set_nz16(ss, a);   /* C08483 lda #$0540 */
  SIMM16(0x8486); y = 0x0D42; ss_set_nz16(ss, y);   /* C08486 ldy #$0D42 */
  SIMM16(0x8489); x = 0x0050; ss_set_nz16(ss, x);   /* C08489 ldx #$0050 */
...
void mode1_level_init(SnesState* ss) {
  ...
  SIMM16(0x8514); a = 0x03FF; ss_set_nz16(ss, a);   /* C08514 lda #$03FF */
  S(0x8517, 2);                             /* C08517 sta level_width_mask */
  t_write16_dp(ss, dp, level_width_mask, a);
  SIMM16(0x8519); a = 0x0030; ss_set_nz16(ss, a);   /* C08519 lda #$0030 */
  S(0x851C, 2);                             /* C0851C sta level_height_mask */
  t_write16_dp(ss, dp, level_height_mask, a);
  SIMM16(0x851E); a = 0x0001; ss_set_nz16(ss, a);   /* C0851E lda #$0001 */
  S(0x8521, 2);                             /* C08521 sta $82 */
  t_write16_dp(ss, dp, layer2_parallax_shift, a);
  SIMM16(0x8523); a = 0x0010; ss_set_nz16(ss, a);   /* C08523 lda #$0010 */
  S(0x8526, 2);                             /* C08526 sta $84 */
  t_write16_dp(ss, dp, layer2_row_height, a);
  SIMM16(0x8528); a = 0xFD80; ss_set_nz16(ss, a);   /* C08528 lda #$FD80 */
  S(0x852B, 2);                             /* C0852B sta tilemap_a_addr */
  t_write16_dp(ss, dp, tilemap_a_addr, a);
  SIMM16(0x852D); a = 0xC9C9; ss_set_nz16(ss, a);   /* C0852D lda #$C9C9 */
  S(0x8530, 2);                             /* C08530 sta tilemap_a_bank */
  t_write16_dp(ss, dp, tilemap_a_bank, a);
  SIMM16(0x8532); a = 0x26A0; ss_set_nz16(ss, a);   /* C08532 lda #$26A0 */
  S(0x8535, 2);                             /* C08535 sta tilemap_b_addr */
  t_write16_dp(ss, dp, tilemap_b_addr, a);
  SIMM16(0x8537); a = 0xCACA; ss_set_nz16(ss, a);   /* C08537 lda #$CACA */
  S(0x853A, 2);                             /* C0853A sta metatile_data_bank */
  t_write16_dp(ss, dp, metatile_data_bank, a);
  S(0x853C, 2);                             /* C0853C stz $60 */
  t_write16_dp(ss, dp, scroll_scratch_60, 0);
  SIMM16(0x853E); a = 0x0018; ss_set_nz16(ss, a);   /* C0853E lda #$0018 */
  S(0x8541, 2);                             /* C08541 sta camera_y */
  t_write16_dp(ss, dp, camera_y, a);
  SIMM16(0x8543); a = 0x0300; ss_set_nz16(ss, a);   /* C08543 lda #$0300 */
  ...
  for(;;) {                                 /* loc_C08546 */
    ...
    SIMM16(0x8551); a = alu_adc16(ss, a, 0x0008);   /* C08551 adc #$0008 */
    SIMM16(0x8554); alu_cmp16(ss, a, 0x0400); /* C08554 cmp #$0400 */
    const bool again = !ss_z(ss);
  ...
  SIMM16(0x855B); a = 0x2000; ss_set_nz16(ss, a);   /* C0855B lda #$2000 */
  S(0x855E, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C0855E sta VMADDL */
  SIMM16(0x8561); x = 0x00C8; ss_set_nz16(ss, x);   /* C08561 ldx #$00C8 */
  SIMM16(0x8564); a = 0x6AC0; ss_set_nz16(ss, a);   /* C08564 lda #$6AC0 */
  SIMM16(0x8567); y = 0x6000; ss_set_nz16(ss, y);   /* C08567 ldy #$6000 */
  JSR(0x856A, dma_upload_to_vram_addr);     /* C0856A jsr dma_upload_to_vram */

  SIMM16(0x856D); a = 0x5000; ss_set_nz16(ss, a);   /* C0856D lda #$5000 */
  S(0x8570, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08570 sta VMADDL */
  SIMM16(0x8573); x = 0x00C8; ss_set_nz16(ss, x);   /* C08573 ldx #$00C8 */
  SIMM16(0x8576); a = 0xC980; ss_set_nz16(ss, a);   /* C08576 lda #$C980 */
  SIMM16(0x8579); y = 0x3620; ss_set_nz16(ss, y);   /* C08579 ldy #$3620 */
  JSR(0x857C, dma_upload_to_vram_addr);     /* C0857C jsr dma_upload_to_vram */

  SIMM16(0x857F); a = 0x6C00; ss_set_nz16(ss, a);   /* C0857F lda #$6C00 */
  JSR(0x8582, dma_fill_vram_zero_addr);     /* C08582 jsr dma_fill_vram_zero */

  SIMM16(0x8585); a = 0x6C40; ss_set_nz16(ss, a);   /* C08585 lda #$6C40 */
  S(0x8588, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08588 sta VMADDL */
  SIMM16(0x858B); x = 0x00CB; ss_set_nz16(ss, x);   /* C0858B ldx #$00CB */
  SIMM16(0x858E); a = 0x0000; ss_set_nz16(ss, a);   /* C0858E lda #$0000 */
  SIMM16(0x8591); y = 0x0800; ss_set_nz16(ss, y);   /* C08591 ldy #$0800 */
  JSR(0x8594, dma_upload_to_vram_addr);     /* C08594 jsr dma_upload_to_vram */

  SIMM16(0x8597); a = 0x7020; ss_set_nz16(ss, a);   /* C08597 lda #$7020 */
  S(0x859A, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C0859A sta VMADDL */
  SIMM16(0x859D); x = 0x00CC; ss_set_nz16(ss, x);   /* C0859D ldx #$00CC */
  SIMM16(0x85A0); a = 0xAB02; ss_set_nz16(ss, a);   /* C085A0 lda #$AB02 */
  SIMM16(0x85A3); y = 0x0700; ss_set_nz16(ss, y);   /* C085A3 ldy #$0700 */
  JSR(0x85A6, dma_upload_to_vram_addr);     /* C085A6 jsr dma_upload_to_vram */

  SIMM16(0x85A9); a = 0x7000; ss_set_nz16(ss, a);   /* C085A9 lda #$7000 */
  S(0x85AC, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C085AC sta VMADDL */
  SIMM16(0x85AF); x = 0x00CC; ss_set_nz16(ss, x);   /* C085AF ldx #$00CC */
  SIMM16(0x85B2); a = 0xAB02; ss_set_nz16(ss, a);   /* C085B2 lda #$AB02 */
  SIMM16(0x85B5); y = 0x0700; ss_set_nz16(ss, y);   /* C085B5 ldy #$0700 */
  JSR(0x85B8, dma_upload_to_vram_addr);     /* C085B8 jsr dma_upload_to_vram */

  SIMM16(0x85BB); a = 0x7420; ss_set_nz16(ss, a);   /* C085BB lda #$7420 */
  S(0x85BE, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C085BE sta VMADDL */
  SIMM16(0x85C1); x = 0x00CC; ss_set_nz16(ss, x);   /* C085C1 ldx #$00CC */
  SIMM16(0x85C4); a = 0xA402; ss_set_nz16(ss, a);   /* C085C4 lda #$A402 */
  SIMM16(0x85C7); y = 0x0700; ss_set_nz16(ss, y);   /* C085C7 ldy #$0700 */
  JSR(0x85CA, dma_upload_to_vram_addr);     /* C085CA jsr dma_upload_to_vram */

  SIMM16(0x85CD); a = 0x7400; ss_set_nz16(ss, a);   /* C085CD lda #$7400 */
  S(0x85D0, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C085D0 sta VMADDL */
  SIMM16(0x85D3); x = 0x00CC; ss_set_nz16(ss, x);   /* C085D3 ldx #$00CC */
  SIMM16(0x85D6); a = 0xA402; ss_set_nz16(ss, a);   /* C085D6 lda #$A402 */
  SIMM16(0x85D9); y = 0x0700; ss_set_nz16(ss, y);   /* C085D9 ldy #$0700 */
  JSR(0x85DC, dma_upload_to_vram_addr);     /* C085DC jsr dma_upload_to_vram */

  SIMM16(0x85DF); x = 0x0000; ss_set_nz16(ss, x);   /* C085DF ldx #$0000 */
  SIMM16(0x85E2); a = 0x0068; ss_set_nz16(ss, a);   /* C085E2 lda #$0068 */
  S(0x85E5, 4);                             /* C085E5 sta $7F0000,X */
  t_write16(ss, (0x7F0000 + x) & 0xffffff, a);
  SIMM16(0x85E9); a = 0x00A8; ss_set_nz16(ss, a);   /* C085E9 lda #$00A8 */
  ...
  for(;;) {                                 /* loc_C085F3 */
    SIMM16(0x85F3); a = 0x0090; ss_set_nz16(ss, a); /* C085F3 lda #$0090 */
    S(0x85F6, 4);                           /* C085F6 sta $7F0000,X */
    t_write16(ss, (0x7F0000 + x) & 0xffffff, a);
    SIMM16(0x85FA); a = 0x00AC; ss_set_nz16(ss, a); /* C085FA lda #$00AC */
    ...
    SIMM16(0x8604); alu_cpx16(ss, x, 0x0033); /* C08604 cpx #$0033 */
    const bool again = !ss_z(ss);
    S(0x8607, 1); t_branch(ss, again);      /* C08607 bne loc_C085F3 */
    if(!again) break;
  }

  SIMM16(0x8609); x = 0x0040; ss_set_nz16(ss, x);   /* C08609 ldx #$0040 */
  SIMM16(0x860C); a = 0x0062; ss_set_nz16(ss, a);   /* C0860C lda #$0062 */
  S(0x860F, 4);                             /* C0860F sta $7F0000,X */
  t_write16(ss, (0x7F0000 + x) & 0xffffff, a);
  SIMM16(0x8613); a = 0x84B5; ss_set_nz16(ss, a);   /* C08613 lda #$84B5 */
  ...
  for(;;) {                                 /* loc_C0861D */
    SIMM16(0x861D); a = 0x0090; ss_set_nz16(ss, a); /* C0861D lda #$0090 */
    S(0x8620, 4);                           /* C08620 sta $7F0000,X */
    t_write16(ss, (0x7F0000 + x) & 0xffffff, a);
    SIMM16(0x8624); a = 0x84B5; ss_set_nz16(ss, a); /* C08624 lda #$84B5 */
    ...
    SIMM16(0x862E); alu_cpx16(ss, x, 0x0070); /* C0862E cpx #$0070 */
    const bool again = !ss_z(ss);
    S(0x8631, 1); t_branch(ss, again);      /* C08631 bne loc_C0861D */
    if(!again) break;
  }

  SIMM16(0x8633); x = 0x0080; ss_set_nz16(ss, x);   /* C08633 ldx #$0080 */
  SIMM16(0x8636); a = 0x0070; ss_set_nz16(ss, a);   /* C08636 lda #$0070 */
  S(0x8639, 4);                             /* C08639 sta $7F0000,X */
  t_write16(ss, (0x7F0000 + x) & 0xffffff, a);
  SIMM16(0x863D); a = 0x0000; ss_set_nz16(ss, a);   /* C0863D lda #$0000 */
  S(0x8640, 4);                             /* C08640 sta $7F0001,X */
  t_write16(ss, (0x7F0001 + x) & 0xffffff, a);
  SIMM16(0x8644); a = 0x0040; ss_set_nz16(ss, a);   /* C08644 lda #$0040 */
  S(0x8647, 4);                             /* C08647 sta $7F0003,X */
  t_write16(ss, (0x7F0003 + x) & 0xffffff, a);
  SIMM16(0x864B); a = 0x0000; ss_set_nz16(ss, a);   /* C0864B lda #$0000 */
  S(0x864E, 4);                             /* C0864E sta $7F0004,X */
  t_write16(ss, (0x7F0004 + x) & 0xffffff, a);
  SIMM16(0x8652); a = 0x0001; ss_set_nz16(ss, a);   /* C08652 lda #$0001 */
  S(0x8655, 4);                             /* C08655 sta $7F0006,X */
  t_write16(ss, (0x7F0006 + x) & 0xffffff, a);
  SIMM16(0x8659); a = 0x0000; ss_set_nz16(ss, a);   /* C08659 lda #$0000 */
  ...
  SIMM16(0x8666); x = 0x2103; ss_set_nz16(ss, x);   /* C08666 ldx #$2103 */
  S(0x8669, 3); t_write16(ss, ss_abs(ss, DMAP1), x);   /* C08669 stx DMAP1 */
  SIMM16(0x866C); x = 0x6FA8; ss_set_nz16(ss, x);   /* C0866C ldx #$6FA8 */
  S(0x866F, 3); t_write16(ss, ss_abs(ss, A1TL1), x);   /* C0866F stx A1TL1 */
  SIMM8(0x8672);                            /* C08672 lda #$C4 */
  ...
  SIMM16(0x8711); a = 0x0068; ss_set_nz16(ss, a);   /* C08711 lda #$0068 */
  S(0x8714, 4); t_write16(ss, 0x7F00C0, a); /* C08714 sta $7F00C0 */
  SIMM16(0x8718); a = 0x0000; ss_set_nz16(ss, a);   /* C08718 lda #$0000 */
  S(0x871B, 4); t_write16(ss, 0x7F00C1, a); /* C0871B sta $7F00C1 */
  SIMM16(0x871F); a = 0x0002; ss_set_nz16(ss, a);   /* C0871F lda #$0002 */
  S(0x8722, 4); t_write16(ss, 0x7F00C3, a); /* C08722 sta $7F00C3 */
  SIMM16(0x8726); a = 0x0000; ss_set_nz16(ss, a);   /* C08726 lda #$0000 */
  S(0x8729, 4); t_write16(ss, 0x7F00C4, a); /* C08729 sta $7F00C4 */
  S(0x872D, 4); t_write16(ss, 0x7F00C6, a); /* C0872D sta $7F00C6 */

  SIMM16(0x8731); y = 0x0080; ss_set_nz16(ss, y);   /* C08731 ldy #$0080 */
  SIMM16(0x8734); x = 0x0020; ss_set_nz16(ss, x);   /* C08734 ldx #$0020 */
  SIMM16(0x8737); a = 0x6C48; ss_set_nz16(ss, a);   /* C08737 lda #$6C48 */
  JSR(0x873A, dma_upload_to_cgram_addr);    /* C0873A jsr dma_upload_to_cgram */

  SIMM16(0x873D); y = 0x00A0; ss_set_nz16(ss, y);   /* C0873D ldy #$00A0 */
  SIMM16(0x8740); x = 0x0004; ss_set_nz16(ss, x);   /* C08740 ldx #$0004 */
  SIMM16(0x8743); a = 0x6D08; ss_set_nz16(ss, a);   /* C08743 lda #$6D08 */
  JSR(0x8746, dma_upload_to_cgram_addr);    /* C08746 jsr dma_upload_to_cgram */

  SIMM16(0x8749); y = 0x0000; ss_set_nz16(ss, y);   /* C08749 ldy #$0000 */
  SIMM16(0x874C); x = 0x0020; ss_set_nz16(ss, x);   /* C0874C ldx #$0020 */
  SIMM16(0x874F); a = 0x6EA8; ss_set_nz16(ss, a);   /* C0874F lda #$6EA8 */
  ...
  SIMM16(0x8758); a = 0x1E00; ss_set_nz16(ss, a);   /* C08758 lda #$1E00 */
  S(0x875B, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C0875B sta VMADDL */
  SIMM16(0x875E); x = 0x00C5; ss_set_nz16(ss, x);   /* C0875E ldx #$00C5 */
  SIMM16(0x8761); a = 0x0000; ss_set_nz16(ss, a);   /* C08761 lda #$0000 */
  SIMM16(0x8764); y = 0x0200; ss_set_nz16(ss, y);   /* C08764 ldy #$0200 */
  ...
  SIMM16(0x876D); y = 0x00B0; ss_set_nz16(ss, y);   /* C0876D ldy #$00B0 */
  SIMM16(0x8770); x = 0x0004; ss_set_nz16(ss, x);   /* C08770 ldx #$0004 */
  SIMM16(0x8773); a = 0x6D88; ss_set_nz16(ss, a);   /* C08773 lda #$6D88 */
  JSR(0x8776, dma_upload_to_cgram_addr);    /* C08776 jsr dma_upload_to_cgram */

  SEP(0x8779, 0x20);                        /* C08779 sep #$20 */
  SIMM8(0x877B);                            /* C0877B lda #$E1 */
...
void mode2_level_init(SnesState* ss) {
  ...
  SIMM16(0x87C8); a = 0x06FF; ss_set_nz16(ss, a);   /* C087C8 lda #$06FF */
  S(0x87CB, 2);                             /* C087CB sta level_width_mask */
  t_write16_dp(ss, dp, level_width_mask, a);
  SIMM16(0x87CD); a = 0x02A0; ss_set_nz16(ss, a);   /* C087CD lda #$02A0 */
  S(0x87D0, 2);                             /* C087D0 sta level_height_mask */
  t_write16_dp(ss, dp, level_height_mask, a);
  SIMM16(0x87D2); a = 0xFFFF; ss_set_nz16(ss, a);   /* C087D2 lda #$FFFF */
  S(0x87D5, 2);                             /* C087D5 sta $82 */
  t_write16_dp(ss, dp, layer2_parallax_shift, a);
  SIMM16(0x87D7); a = 0x0030; ss_set_nz16(ss, a);   /* C087D7 lda #$0030 */
  S(0x87DA, 2);                             /* C087DA sta $84 */
  t_write16_dp(ss, dp, layer2_row_height, a);
  SIMM16(0x87DC); a = 0x5760; ss_set_nz16(ss, a);   /* C087DC lda #$5760 */
  S(0x87DF, 2);                             /* C087DF sta tilemap_a_addr */
  t_write16_dp(ss, dp, tilemap_a_addr, a);
  SIMM16(0x87E1); a = 0xCACA; ss_set_nz16(ss, a);   /* C087E1 lda #$CACA */
  S(0x87E4, 2);                             /* C087E4 sta tilemap_a_bank */
  t_write16_dp(ss, dp, tilemap_a_bank, a);
  SIMM16(0x87E6); a = 0xB560; ss_set_nz16(ss, a);   /* C087E6 lda #$B560 */
  S(0x87E9, 2);                             /* C087E9 sta tilemap_b_addr */
  t_write16_dp(ss, dp, tilemap_b_addr, a);
  SIMM16(0x87EB); a = 0xC9C9; ss_set_nz16(ss, a);   /* C087EB lda #$C9C9 */
  S(0x87EE, 2);                             /* C087EE sta metatile_data_bank */
  t_write16_dp(ss, dp, metatile_data_bank, a);
  S(0x87F0, 2);                             /* C087F0 stz layer_parallax_mode */
  t_write16_dp(ss, dp, layer_parallax_mode, 0);
  S(0x87F2, 2);                             /* C087F2 stz camera_y_lookahead */
  t_write16_dp(ss, dp, camera_y_lookahead, 0);
  S(0x87F4, 2);                             /* C087F4 stz $60 */
  t_write16_dp(ss, dp, scroll_scratch_60, 0);
  SIMM16(0x87F6); a = 0x0015; ss_set_nz16(ss, a);   /* C087F6 lda #$0015 */
  S(0x87F9, 2);                             /* C087F9 sta camera_y */
  t_write16_dp(ss, dp, camera_y, a);
  SIMM16(0x87FB); a = 0x0600; ss_set_nz16(ss, a);   /* C087FB lda #$0600 */
  ...
  for(;;) {                                 /* loc_C087FE */
    ...
    SIMM16(0x8809); a = alu_adc16(ss, a, 0x0008);   /* C08809 adc #$0008 */
    SIMM16(0x880C); alu_cmp16(ss, a, 0x0700); /* C0880C cmp #$0700 */
    const bool again = !ss_z(ss);
  ...
  SIMM16(0x8813); a = 0x2000; ss_set_nz16(ss, a);   /* C08813 lda #$2000 */
  S(0x8816, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08816 sta VMADDL */
  SIMM16(0x8819); x = 0x00C7; ss_set_nz16(ss, x);   /* C08819 ldx #$00C7 */
  SIMM16(0x881C); a = 0x0342; ss_set_nz16(ss, a);   /* C0881C lda #$0342 */
  SIMM16(0x881F); y = 0x6FC0; ss_set_nz16(ss, y);   /* C0881F ldy #$6FC0 */
  JSR(0x8822, dma_upload_to_vram_addr);     /* C08822 jsr dma_upload_to_vram */

  SIMM16(0x8825); a = 0x5800; ss_set_nz16(ss, a);   /* C08825 lda #$5800 */
  S(0x8828, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08828 sta VMADDL */
  SIMM16(0x882B); x = 0x00CB; ss_set_nz16(ss, x);   /* C0882B ldx #$00CB */
  SIMM16(0x882E); a = 0x1000; ss_set_nz16(ss, a);   /* C0882E lda #$1000 */
  SIMM16(0x8831); y = 0x0800; ss_set_nz16(ss, y);   /* C08831 ldy #$0800 */
  JSR(0x8834, dma_upload_to_vram_addr);     /* C08834 jsr dma_upload_to_vram */

  SIMM16(0x8837); a = 0x5C00; ss_set_nz16(ss, a);   /* C08837 lda #$5C00 */
  JSR(0x883A, dma_fill_vram_zero_addr);     /* C0883A jsr dma_fill_vram_zero */

  SIMM16(0x883D); a = 0x6000; ss_set_nz16(ss, a);   /* C0883D lda #$6000 */
  S(0x8840, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08840 sta VMADDL */
  SIMM16(0x8843); x = 0x00C7; ss_set_nz16(ss, x);   /* C08843 ldx #$00C7 */
  SIMM16(0x8846); a = 0xDF82; ss_set_nz16(ss, a);   /* C08846 lda #$DF82 */
  SIMM16(0x8849); y = 0x19E0; ss_set_nz16(ss, y);   /* C08849 ldy #$19E0 */
  JSR(0x884C, dma_upload_to_vram_addr);     /* C0884C jsr dma_upload_to_vram */

  SIMM16(0x884F); a = 0x7400; ss_set_nz16(ss, a);   /* C0884F lda #$7400 */
  S(0x8852, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08852 sta VMADDL */
  SIMM16(0x8855); x = 0x00CB; ss_set_nz16(ss, x);   /* C08855 ldx #$00CB */
  SIMM16(0x8858); a = 0x0800; ss_set_nz16(ss, a);   /* C08858 lda #$0800 */
  SIMM16(0x885B); y = 0x0800; ss_set_nz16(ss, y);   /* C0885B ldy #$0800 */
  JSR(0x885E, dma_upload_to_vram_addr);     /* C0885E jsr dma_upload_to_vram */

  SIMM16(0x8861); y = 0x0080; ss_set_nz16(ss, y);   /* C08861 ldy #$0080 */
  SIMM16(0x8864); x = 0x0020; ss_set_nz16(ss, x);   /* C08864 ldx #$0020 */
  SIMM16(0x8867); a = 0x6C48; ss_set_nz16(ss, a);   /* C08867 lda #$6C48 */
  JSR(0x886A, dma_upload_to_cgram_addr);    /* C0886A jsr dma_upload_to_cgram */

  SIMM16(0x886D); y = 0x00C0; ss_set_nz16(ss, y);   /* C0886D ldy #$00C0 */
  SIMM16(0x8870); x = 0x0010; ss_set_nz16(ss, x);   /* C08870 ldx #$0010 */
  SIMM16(0x8873); a = 0x6C48; ss_set_nz16(ss, a);   /* C08873 lda #$6C48 */
  JSR(0x8876, dma_upload_to_cgram_addr);    /* C08876 jsr dma_upload_to_cgram */

  SIMM16(0x8879); y = 0x00E0; ss_set_nz16(ss, y);   /* C08879 ldy #$00E0 */
  SIMM16(0x887C); x = 0x0004; ss_set_nz16(ss, x);   /* C0887C ldx #$0004 */
  SIMM16(0x887F); a = 0x6CC8; ss_set_nz16(ss, a);   /* C0887F lda #$6CC8 */
  JSR(0x8882, dma_upload_to_cgram_addr);    /* C08882 jsr dma_upload_to_cgram */

  SIMM16(0x8885); y = 0x0000; ss_set_nz16(ss, y);   /* C08885 ldy #$0000 */
  SIMM16(0x8888); x = 0x0020; ss_set_nz16(ss, x);   /* C08888 ldx #$0020 */
  SIMM16(0x888B); a = 0x6FE3; ss_set_nz16(ss, a);   /* C0888B lda #$6FE3 */
  ...
  SIMM16(0x8894); a = 0x0080; ss_set_nz16(ss, a);   /* C08894 lda #$0080 */
  S(0x8897, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C08897 sta ptr_04 */
  SIMM16(0x8899); a = 0x88A6; ss_set_nz16(ss, a);   /* C08899 lda #$88A6 */
  SIMM16(0x889C); y = 0x2C00; ss_set_nz16(ss, y);   /* C0889C ldy #$2C00 */
  SIMM16(0x889F); x = 0x0010; ss_set_nz16(ss, x);   /* C0889F ldx #$0010 */
...
void title_screen_init(SnesState* ss) {
  ...
  t_write16(ss, ss_abs(ss, state_row_offset), 0);
  SIMM16(0x88AE); a = 0x0009; ss_set_nz16(ss, a);   /* C088AE lda #$0009 */
  S(0x88B1, 3); t_write16(ss, ss_abs(ss, BGMODE), a);   /* C088B1 sta BGMODE */
  SIMM16(0x88B4); a = 0x0013; ss_set_nz16(ss, a);   /* C088B4 lda #$0013 */
  S(0x88B7, 3); t_write16(ss, ss_abs(ss, TM), a);       /* C088B7 sta TM */
  SIMM16(0x88BA); a = 0x1202; ss_set_nz16(ss, a);   /* C088BA lda #$1202 */
  S(0x88BD, 3); t_write16(ss, ss_abs(ss, CGWSEL), a);   /* C088BD sta CGWSEL */
  SIMM16(0x88C0); a = 0x7958; ss_set_nz16(ss, a);   /* C088C0 lda #$7958 */
  S(0x88C3, 3); t_write16(ss, ss_abs(ss, BG1SC), a);    /* C088C3 sta BG1SC */
  SIMM16(0x88C6); a = 0x0626; ss_set_nz16(ss, a);   /* C088C6 lda #$0626 */
  S(0x88C9, 3); t_write16(ss, ss_abs(ss, BG12NBA), a);  /* C088C9 sta BG12NBA */

  SEP(0x88CC, 0x20);                        /* C088CC sep #$20 */
  SIMM8(0x88CE);                            /* C088CE lda #$5C */
  a = (uint16_t) ((a & 0xff00) | 0x5C); ss_set_nz8(ss, 0x5C);
  S(0x88D0, 3); t_write8(ss, ss_abs(ss, BG3SC), 0x5C);  /* C088D0 sta BG3SC */
  SIMM8(0x88D3);                            /* C088D3 lda #$E0 */
  a = (uint16_t) ((a & 0xff00) | 0xE0); ss_set_nz8(ss, 0xE0);
  S(0x88D5, 3); t_write8(ss, ss_abs(ss, COLDATA), 0xE0);/* C088D5 sta COLDATA */
  JSR(0x88D8, set_bg_scroll_addr);          /* C088D8 jsr set_bg_scroll */

  SIMM16(0x88DB); a = 0x02FF; ss_set_nz16(ss, a);   /* C088DB lda #$02FF */
  S(0x88DE, 2);                             /* C088DE sta level_width_mask */
  t_write16_dp(ss, dp, level_width_mask, a);
  SIMM16(0x88E0); a = 0x02A0; ss_set_nz16(ss, a);   /* C088E0 lda #$02A0 */
  S(0x88E3, 2);                             /* C088E3 sta level_height_mask */
  t_write16_dp(ss, dp, level_height_mask, a);
  SIMM16(0x88E5); a = 0xFFFF; ss_set_nz16(ss, a);   /* C088E5 lda #$FFFF */
  S(0x88E8, 2);                             /* C088E8 sta $82 */
  t_write16_dp(ss, dp, layer2_parallax_shift, a);
  SIMM16(0x88EA); a = 0x0030; ss_set_nz16(ss, a);   /* C088EA lda #$0030 */
  S(0x88ED, 2);                             /* C088ED sta $84 */
  t_write16_dp(ss, dp, layer2_row_height, a);
  SIMM16(0x88EF); a = 0x8714; ss_set_nz16(ss, a);   /* C088EF lda #$8714 */
  S(0x88F2, 2);                             /* C088F2 sta tilemap_a_addr */
  t_write16_dp(ss, dp, tilemap_a_addr, a);
  SIMM16(0x88F4); a = 0xCECE; ss_set_nz16(ss, a);   /* C088F4 lda #$CECE */
  S(0x88F7, 2);                             /* C088F7 sta tilemap_a_bank */
  t_write16_dp(ss, dp, tilemap_a_bank, a);
  SIMM16(0x88F9); a = 0x37A0; ss_set_nz16(ss, a);   /* C088F9 lda #$37A0 */
  S(0x88FC, 2);                             /* C088FC sta tilemap_b_addr */
  t_write16_dp(ss, dp, tilemap_b_addr, a);
  SIMM16(0x88FE); a = 0xCACA; ss_set_nz16(ss, a);   /* C088FE lda #$CACA */
  S(0x8901, 2);                             /* C08901 sta metatile_data_bank */
  t_write16_dp(ss, dp, metatile_data_bank, a);
  SIMM16(0x8903); a = 0xFFFF; ss_set_nz16(ss, a);   /* C08903 lda #$FFFF */
  ...
  t_write16_dp(ss, dp, scroll_scratch_60, 0);
  SIMM16(0x890C); a = 0x0088; ss_set_nz16(ss, a);   /* C0890C lda #$0088 */
  S(0x890F, 2);                             /* C0890F sta camera_y */
  t_write16_dp(ss, dp, camera_y, a);
  SIMM16(0x8911); a = 0x0000; ss_set_nz16(ss, a);   /* C08911 lda #$0000 */
  ...
  for(;;) {                                 /* loc_C08914 */
    ...
    SIMM16(0x891F); a = alu_adc16(ss, a, 0x0008);   /* C0891F adc #$0008 */
    SIMM16(0x8922); alu_cmp16(ss, a, 0x0100); /* C08922 cmp #$0100 */
    const bool again = !ss_z(ss);
  ...
  SIMM16(0x8929); a = 0x1800; ss_set_nz16(ss, a);   /* C08929 lda #$1800 */
  JSR(0x892C, dma_fill_vram_zero_addr);     /* C0892C jsr dma_fill_vram_zero */

  SIMM16(0x892F); a = 0x1C00; ss_set_nz16(ss, a);   /* C0892F lda #$1C00 */
  S(0x8932, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08932 sta VMADDL */
  SIMM16(0x8935); x = 0x00CB; ss_set_nz16(ss, x);   /* C08935 ldx #$00CB */
  SIMM16(0x8938); a = 0x3000; ss_set_nz16(ss, a);   /* C08938 lda #$3000 */
  SIMM16(0x893B); y = 0x0800; ss_set_nz16(ss, y);   /* C0893B ldy #$0800 */
  JSR(0x893E, dma_upload_to_vram_addr);     /* C0893E jsr dma_upload_to_vram */

  SIMM16(0x8941); a = 0x2000; ss_set_nz16(ss, a);   /* C08941 lda #$2000 */
  S(0x8944, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08944 sta VMADDL */
  SIMM16(0x8947); x = 0x00C8; ss_set_nz16(ss, x);   /* C08947 ldx #$00C8 */
  SIMM16(0x894A); a = 0x0000; ss_set_nz16(ss, a);   /* C0894A lda #$0000 */
  SIMM16(0x894D); y = 0x6AC0; ss_set_nz16(ss, y);   /* C0894D ldy #$6AC0 */
  JSR(0x8950, dma_upload_to_vram_addr);     /* C08950 jsr dma_upload_to_vram */

  SIMM16(0x8953); a = 0x5800; ss_set_nz16(ss, a);   /* C08953 lda #$5800 */
  S(0x8956, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08956 sta VMADDL */
  SIMM16(0x8959); x = 0x00CB; ss_set_nz16(ss, x);   /* C08959 ldx #$00CB */
  SIMM16(0x895C); a = 0x3800; ss_set_nz16(ss, a);   /* C0895C lda #$3800 */
  SIMM16(0x895F); y = 0x0800; ss_set_nz16(ss, y);   /* C0895F ldy #$0800 */
  JSR(0x8962, dma_upload_to_vram_addr);     /* C08962 jsr dma_upload_to_vram */

  SIMM16(0x8965); a = 0x5C00; ss_set_nz16(ss, a);   /* C08965 lda #$5C00 */
  S(0x8968, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C08968 sta VMADDL */
  SIMM16(0x896B); x = 0x00CB; ss_set_nz16(ss, x);   /* C0896B ldx #$00CB */
  SIMM16(0x896E); a = 0x2800; ss_set_nz16(ss, a);   /* C0896E lda #$2800 */
  SIMM16(0x8971); y = 0x0800; ss_set_nz16(ss, y);   /* C08971 ldy #$0800 */
  JSR(0x8974, dma_upload_to_vram_addr);     /* C08974 jsr dma_upload_to_vram */

  SIMM16(0x8977); a = 0x6000; ss_set_nz16(ss, a);   /* C08977 lda #$6000 */
  S(0x897A, 3); t_write16(ss, ss_abs(ss, VMADDL), a);  /* C0897A sta VMADDL */
  SIMM16(0x897D); x = 0x00C9; ss_set_nz16(ss, x);   /* C0897D ldx #$00C9 */
  SIMM16(0x8980); a = 0x5AC0; ss_set_nz16(ss, a);   /* C08980 lda #$5AC0 */
  SIMM16(0x8983); y = 0x3000; ss_set_nz16(ss, y);   /* C08983 ldy #$3000 */
  JSR(0x8986, dma_upload_to_vram_addr);     /* C08986 jsr dma_upload_to_vram */

  SIMM16(0x8989); y = 0x0080; ss_set_nz16(ss, y);   /* C08989 ldy #$0080 */
  SIMM16(0x898C); x = 0x0020; ss_set_nz16(ss, x);   /* C0898C ldx #$0020 */
  SIMM16(0x898F); a = 0x6C48; ss_set_nz16(ss, a);   /* C0898F lda #$6C48 */
  JSR(0x8992, dma_upload_to_cgram_addr);    /* C08992 jsr dma_upload_to_cgram */

  SIMM16(0x8995); y = 0x00C0; ss_set_nz16(ss, y);   /* C08995 ldy #$00C0 */
  SIMM16(0x8998); x = 0x0010; ss_set_nz16(ss, x);   /* C08998 ldx #$0010 */
  SIMM16(0x899B); a = 0x6C48; ss_set_nz16(ss, a);   /* C0899B lda #$6C48 */
  JSR(0x899E, dma_upload_to_cgram_addr);    /* C0899E jsr dma_upload_to_cgram */

  SIMM16(0x89A1); y = 0x00A0; ss_set_nz16(ss, y);   /* C089A1 ldy #$00A0 */
  SIMM16(0x89A4); x = 0x0004; ss_set_nz16(ss, x);   /* C089A4 ldx #$0004 */
  SIMM16(0x89A7); a = 0x7443; ss_set_nz16(ss, a);   /* C089A7 lda #$7443 */
  JSR(0x89AA, dma_upload_to_cgram_addr);    /* C089AA jsr dma_upload_to_cgram */

  SIMM16(0x89AD); y = 0x0000; ss_set_nz16(ss, y);   /* C089AD ldy #$0000 */
  SIMM16(0x89B0); x = 0x0020; ss_set_nz16(ss, x);   /* C089B0 ldx #$0020 */
  SIMM16(0x89B3); a = 0x7343; ss_set_nz16(ss, a);   /* C089B3 lda #$7343 */
  JSR(0x89B6, dma_upload_to_cgram_addr);    /* C089B6 jsr dma_upload_to_cgram */

  SIMM16(0x89B9); a = 0x0040; ss_set_nz16(ss, a);   /* C089B9 lda #$0040 */
  S(0x89BC, 4); t_write16(ss, 0x7F00D0, a); /* C089BC sta $7F00D0 */
  SIMM16(0x89C0); a = 0x0038; ss_set_nz16(ss, a);   /* C089C0 lda #$0038 */
  S(0x89C3, 4); t_write16(ss, 0x7F00D3, a); /* C089C3 sta $7F00D3 */
  SIMM16(0x89C7); a = 0x0001; ss_set_nz16(ss, a);   /* C089C7 lda #$0001 */
  S(0x89CA, 4); t_write16(ss, 0x7F00D6, a); /* C089CA sta $7F00D6 */
  SIMM16(0x89CE); a = 0x0BF8; ss_set_nz16(ss, a);   /* C089CE lda #$0BF8 */
  ...
  SIMM16(0x89F2); a = 0x1858; ss_set_nz16(ss, a);   /* C089F2 lda #$1858 */
  S(0x89F5, 3); t_write16(ss, ss_abs(ss, 0x0BF8), a); /* C089F5 sta $0BF8 */
  S(0x89F8, 3); t_write16(ss, ss_abs(ss, 0x0BFC), a); /* C089F8 sta $0BFC */
  SIMM16(0x89FB); a = 0x0058; ss_set_nz16(ss, a);   /* C089FB lda #$0058 */
  S(0x89FE, 3); t_write16(ss, ss_abs(ss, 0x0BFA), a); /* C089FE sta $0BFA */
  S(0x8A01, 3); t_write16(ss, ss_abs(ss, 0x0BFE), a); /* C08A01 sta $0BFE */

  SIMM16(0x8A04); a = 0x007F; ss_set_nz16(ss, a);   /* C08A04 lda #$007F */
  S(0x8A07, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C08A07 sta ptr_04 */
  SIMM16(0x8A09); a = 0x00D0; ss_set_nz16(ss, a);   /* C08A09 lda #$00D0 */
  SIMM16(0x8A0C); y = 0x0740; ss_set_nz16(ss, y);   /* C08A0C ldy #$0740 */
  SIMM16(0x8A0F); x = 0x0010; ss_set_nz16(ss, x);   /* C08A0F ldx #$0010 */
  JSR(0x8A12, dma_setup_channel_step_addr); /* C08A12 jsr dma_setup_channel_step */

  SIMM16(0x8A15); a = 0x0080; ss_set_nz16(ss, a);   /* C08A15 lda #$0080 */
  S(0x8A18, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C08A18 sta ptr_04 */
  SIMM16(0x8A1A); a = 0x8A5A; ss_set_nz16(ss, a);   /* C08A1A lda #$8A5A */
  SIMM16(0x8A1D); y = 0x2C01; ss_set_nz16(ss, y);   /* C08A1D ldy #$2C01 */
  SIMM16(0x8A20); x = 0x0020; ss_set_nz16(ss, x);   /* C08A20 ldx #$0020 */
  JSR(0x8A23, dma_setup_channel_step_addr); /* C08A23 jsr dma_setup_channel_step */

  SIMM16(0x8A26); a = 0x0080; ss_set_nz16(ss, a);   /* C08A26 lda #$0080 */
  S(0x8A29, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C08A29 sta ptr_04 */
  SIMM16(0x8A2B); a = 0x8A61; ss_set_nz16(ss, a);   /* C08A2B lda #$8A61 */
  SIMM16(0x8A2E); y = 0x0900; ss_set_nz16(ss, y);   /* C08A2E ldy #$0900 */
  SIMM16(0x8A31); x = 0x0030; ss_set_nz16(ss, x);   /* C08A31 ldx #$0030 */
  JSR(0x8A34, dma_setup_channel_step_addr); /* C08A34 jsr dma_setup_channel_step */

  SIMM16(0x8A37); a = 0x0080; ss_set_nz16(ss, a);   /* C08A37 lda #$0080 */
  S(0x8A3A, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C08A3A sta ptr_04 */
  SIMM16(0x8A3C); a = 0x8A66; ss_set_nz16(ss, a);   /* C08A3C lda #$8A66 */
  SIMM16(0x8A3F); y = 0x1143; ss_set_nz16(ss, y);   /* C08A3F ldy #$1143 */
  SIMM16(0x8A42); x = 0x0040; ss_set_nz16(ss, x);   /* C08A42 ldx #$0040 */
  JSR(0x8A45, dma_setup_channel_step_addr); /* C08A45 jsr dma_setup_channel_step */

  SIMM16(0x8A48); a = 0x0080; ss_set_nz16(ss, a);   /* C08A48 lda #$0080 */
  S(0x8A4B, 2); t_write16_dp(ss, dp, ptr_04, a);  /* C08A4B sta ptr_04 */
  SIMM16(0x8A4D); a = 0x8A6D; ss_set_nz16(ss, a);   /* C08A4D lda #$8A6D */
  SIMM16(0x8A50); y = 0x0D43; ss_set_nz16(ss, y);   /* C08A50 ldy #$0D43 */
  SIMM16(0x8A53); x = 0x0050; ss_set_nz16(ss, x);   /* C08A53 ldx #$0050 */
...
void mode0_camera_zone_update(SnesState* ss) {
  ...
  y = t_read16_dp(ss, dp, zone_settle_timer); ss_set_nz16(ss, y);
  { const bool busy = y != 0;
  ...
  SIMM16(0x8AB7); a = alu_sbc16(ss, a, 0x0400);  /* C08AB7 sbc #$0400 */
  {
    const bool before = (a & 0x8000) != 0;
    S(0x8ABA, 1); t_branch(ss, before);     /* C08ABA bmi loc_C08AC7 */
    if(!before) {
      SIMM16(0x8ABC); alu_cmp16(ss, a, 0x0100);  /* C08ABC cmp #$0100 */
      const bool near = !ss_c(ss);
      S(0x8ABF, 1); t_branch(ss, near);     /* C08ABF bcc loc_C08AC6 */
      if(!near) {
        SIMM16(0x8AC1); a = 0x005A; ss_set_nz16(ss, a);  /* C08AC1 lda #$005A */
  ...
  /* loc_C08AC7 */
  SIMM16(0x8AC7); a = alu_eor16(ss, a, 0xFFFF);  /* C08AC7 eor #$FFFF */
  ...
  SIMM16(0x8ACE); a = alu_adc16(ss, a, 0x0078);  /* C08ACE adc #$0078 */

 loc_8AD1:
  S(0x8AD1, 2);                             /* C08AD1 sta $78 */
  t_write16_dp(ss, dp, zone_settle_timer, a);
 loc_8AD3:
  S(0x8AD3, 2);                             /* C08AD3 stz walk_cycle_parity */
  t_write16_dp(ss, dp, walk_cycle_parity, 0);
 loc_8AD5:
  ...
  SIMM16(0x8AE4); alu_cpx16(ss, x, 0x0090);   /* C08AE4 cpx #$0090 */
 ...
 loc_8B2C:
  ...
  SIMM16(0x8B2F); a = alu_and16(ss, a, 0xCFFF);  /* C08B2F and #$CFFF */
  SIMM16(0x8B32); a = alu_ora16(ss, a, 0x2000);  /* C08B32 ora #$2000 */
  ...
  { const bool idle = a == 0;
    ...
    if(!idle) {
      SIMM16(0x8B3D); a = 0xFFFF; ss_set_nz16(ss, a);   /* C08B3D lda #$FFFF */
      S(0x8B40, 3); t_write16(ss, ss_abs(ss, 0x0C1B), a);  /* C08B40 sta $0C1B */
      SIMM16(0x8B43); a = 0x0080; ss_set_nz16(ss, a);   /* C08B43 lda #$0080 */
      S(0x8B46, 3); t_write16(ss, ss_abs(ss, 0x0C1D), a);  /* C08B46 sta $0C1D */
    } }

  /* loc_C08B49 */
  SIMM16(0x8B49); a = 0x1016; ss_set_nz16(ss, a);   /* C08B49 lda #$1016 */
  S(0x8B4C, 3); t_write16(ss, ss_abs(ss, 0x0BD8), a);  /* C08B4C sta $0BD8 */
  SIMM16(0x8B4F); a = 0x1012; ss_set_nz16(ss, a);   /* C08B4F lda #$1012 */
  S(0x8B52, 3); t_write16(ss, ss_abs(ss, 0x0BDA), a);  /* C08B52 sta $0BDA */
  SIMM16(0x8B55); a = 0x0100; ss_set_nz16(ss, a);   /* C08B55 lda #$0100 */
  S(0x8B58, 3); t_write16(ss, ss_abs(ss, 0x0C00), a);  /* C08B58 sta $0C00 */
  S(0x8B5B, 4);                             /* C08B5B lda $7F00D3 */
  a = t_read16(ss, 0x7F00D3); ss_set_nz16(ss, a);
  SIMM16(0x8B5F); a = alu_and16(ss, a, 0xFF00);  /* C08B5F and #$FF00 */
  SIMM16(0x8B62); a = alu_ora16(ss, a, 0x003C);  /* C08B62 ora #$003C */
  S(0x8B65, 3); t_write16(ss, ss_abs(ss, 0x0C02), a);  /* C08B65 sta $0C02 */
  S(0x8B68, 3); t_write16(ss, ss_abs(ss, 0x0C04), 0);  /* C08B68 stz $0C04 */
  SIMM16(0x8B6B); y = 0x00C1; ss_set_nz16(ss, y);   /* C08B6B ldy #$00C1 */
  SIMM16(0x8B6E); x = 0x0000; ss_set_nz16(ss, x);   /* C08B6E ldx #$0000 */
  SIMM16(0x8B71); a = 0x6C6C; ss_set_nz16(ss, a);   /* C08B71 lda #$6C6C */
 ...
 loc_8B80:
  SIMM16(0x8B80); a = 0x1017; ss_set_nz16(ss, a);   /* C08B80 lda #$1017 */
  S(0x8B83, 3); t_write16(ss, ss_abs(ss, 0x0BD8), a);  /* C08B83 sta $0BD8 */
  SIMM16(0x8B86); a = 0x1013; ss_set_nz16(ss, a);   /* C08B86 lda #$1013 */
  ...
  SIMM16(0x8B8E); a = alu_adc16(ss, a, 0x0088);  /* C08B8E adc #$0088 */
  SI(0x8B91); y = a; ss_set_nz16(ss, y);    /* C08B91 tay */
  SIMM16(0x8B92); a = 0x6969; ss_set_nz16(ss, a);   /* C08B92 lda #$6969 */
  JMP(0x8B95, 0x8E7F);                      /* C08B95 jmp loc_C08E7F */
  return;

 loc_8B98:
  SIMM16(0x8B98); a = 0x0700; ss_set_nz16(ss, a);   /* C08B98 lda #$0700 */
  S(0x8B9B, 1); t_branch(ss, true);         /* C08B9B bra loc_C08BA0 */
  goto loc_8BA0;

 loc_8B9D:
  SIMM16(0x8B9D); a = 0x0500; ss_set_nz16(ss, a);   /* C08B9D lda #$0500 */

 loc_8BA0:
  S(0x8BA0, 3); t_write16(ss, ss_abs(ss, 0x0C0F), a);  /* C08BA0 sta $0C0F */
  SIMM16(0x8BA3); a = 0x1017; ss_set_nz16(ss, a);   /* C08BA3 lda #$1017 */
  S(0x8BA6, 3); t_write16(ss, ss_abs(ss, 0x0BD8), a);  /* C08BA6 sta $0BD8 */
  SIMM16(0x8BA9); a = 0x1417; ss_set_nz16(ss, a);   /* C08BA9 lda #$1417 */
  S(0x8BAC, 3); t_write16(ss, ss_abs(ss, 0x0BDA), a);  /* C08BAC sta $0BDA */
  SIMM16(0x8BAF); y = 0x0020; ss_set_nz16(ss, y);   /* C08BAF ldy #$0020 */
  S(0x8BB2, 3);                             /* C08BB2 lda entity_state */
  a = t_read16(ss, ss_abs(ss, entity_state)); ss_set_nz16(ss, a);
  SIMM16(0x8BB5); a = alu_and16(ss, a, 0xFFFC);  /* C08BB5 and #$FFFC */
  SIMM16(0x8BB8); alu_cmp16(ss, a, 0x0008);   /* C08BB8 cmp #$0008 */
  { const bool other = !ss_z(ss);
    S(0x8BBB, 1); t_branch(ss, other);      /* C08BBB bne loc_C08BC0 */
    if(!other) { SIMM16(0x8BBD); y = 0x0040; ss_set_nz16(ss, y); } }  /* C08BBD ldy #$0040 */

  /* loc_C08BC0 */
  S(0x8BC0, 2);                             /* C08BC0 sty $18 */
  t_write16_dp(ss, dp, scratch_18, y);
...
void cgram_palette_ramp_step(SnesState* ss) {
...

  {
    ...
    if(!down) {
      ...
      SIMM16(0x91C1); a = alu_adc16(ss, a, 0x0080);  /* C091C1 adc #$0080 */
      S(0x91C4, 3); t_write16(ss, ss_abs(ss, 0x0C1D), a);  /* C091C4 sta $0C1D */
      SIMM16(0x91C7); alu_cmp16(ss, a, 0x0800);    /* C091C7 cmp #$0800 */
  ...
  SIMM16(0x91D5); a = alu_sbc16(ss, a, 0x0080);  /* C091D5 sbc #$0080 */
 ...
 loc_91DD:
  ...
  SIMM16(0x91E0); a = alu_and16(ss, a, 0xFF00);  /* C091E0 and #$FF00 */
  SI(0x91E3); a = alu_lsr16(ss, a);         /* C091E3 lsr A */
  SI(0x91E4); a = alu_lsr16(ss, a);         /* C091E4 lsr A */
  SI(0x91E5); ss_set_c(ss, false);          /* C091E5 clc */
  SIMM16(0x91E6); a = alu_adc16(ss, a, 0x7103);  /* C091E6 adc #$7103 */
  S(0x91E9, 3); t_index(ss);                /* C091E9 sta $0B90,X */
  t_write16(ss, ss_abs(ss, (0x0B90 + x)), a);
  SIMM16(0x91EC); a = 0x00C4; ss_set_nz16(ss, a);   /* C091EC lda #$00C4 */
  S(0x91EF, 3); t_index(ss);                /* C091EF sta $0B92,X */
  t_write16(ss, ss_abs(ss, (0x0B92 + x)), a);
  SIMM16(0x91F2); a = 0x0040; ss_set_nz16(ss, a);   /* C091F2 lda #$0040 */
  S(0x91F5, 3); t_index(ss);                /* C091F5 sta $0B8C,X */
  t_write16(ss, ss_abs(ss, (0x0B8C + x)), a);
  SIMM16(0x91F8); a = 0x0080; ss_set_nz16(ss, a);   /* C091F8 lda #$0080 */
  S(0x91FB, 3); t_index(ss);                /* C091FB sta $0B8E,X */
  t_write16(ss, ss_abs(ss, (0x0B8E + x)), a);
  SI(0x91FE); a = x; ss_set_nz16(ss, a);    /* C091FE txa */
  SIMM16(0x91FF); a = alu_adc16(ss, a, 0x0008);  /* C091FF adc #$0008 */
