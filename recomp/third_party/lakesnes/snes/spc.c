...
// dream: unused upstream helper; kept verbatim, marked to silence -Wunused-function
static void spc_writeWord(Spc* spc, uint16_t adrl, uint16_t adrh, uint16_t value) __attribute__((unused));
